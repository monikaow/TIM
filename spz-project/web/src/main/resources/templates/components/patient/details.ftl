...
<script type="text/x-template" id="vc-patient-details">
...
<script>
    Vue.component('vc-patient-details', {
        template: '#vc-patient-details',
        props: [],
        data: function () {
            return {
                form: {
                ...
                patient: ${JSONFactory.stringify(patient)}
            }
        },
        methods: {
            submit: function () {
                if (this.$refs.form.validate()) {
                    ...
                    this.$http.post('/api/patient/details', _this.patient)
